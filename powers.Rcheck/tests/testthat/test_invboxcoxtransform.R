...
library(oldr) # use oldr package to install bimixt version that is compatible with latest version of R (otherwise can't install bimixt on this version of R)
oldr::install.compatible.packages("bimixt", repos='http://cran.us.r-project.org')
